        ...
        <div class="row">
            <div class="col-md-12 small">
                <form>
                    ...
                    <button type="button" class="btn btn-primary" @click="updateTeam()"> Update </button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    export default {
        ...
        mounted() {
            this.editTeam(this.$route.params.teamId);
            this.getNation();
        },
        methods: {
            editTeam(teamId) {
                this.axios.get(`http://127.0.0.1:8000/api/teams/${teamId}`)
                   .then((response) => {
            ...
            updateTeam() {
                this.axios
                    .patch(`http://127.0.0.1:8000/api/teams/${this.$route.params.teamId}`, this.team)
                    .then((response) => {
